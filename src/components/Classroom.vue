...
<template>
    <div class="main">
        ...
        <div class="d-block d-sm-block d-md-block d-lg-none d-xl-none">
            <h3>Расписание аудитории {{classroom}}</h3>
                ...
                <div class="card-body" v-for="(item, index2) in timetable[index]" :key="item.day.value">
                    <div class="lesson" v-if="item.day.nameF != null && item.day.nameS != null">
                        <div class="row">
                            ...
                            <div class="col-5">
                                <a class="s_link" href="classroom-timetable">{{item.day.groupF}}</a>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-12"> 
                        ...
                        <div class="row">
                            <div class="col-12" style="text-align: end; padding-right: 30px;">
                                <a class="s_link" href="classroom-timetable">{{item.day.groupS}}</a>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-12">
                    ...
                    <div class="lesson" v-else>
                        <div class="row">
                            <div class="col-7">{{index2 + 1}}<span class="time">{{item.day.time}}</span></div>
                            <div class="col-5" v-if="item.day.name != null"><a class="s_link" href="classroom-timetable">{{item.day.group}}</a></div>
                            <div class="col-5" v-if="item.day.nameF != null"><a class="s_link" href="classroom-timetable">{{item.day.groupF}}</a></div>
                            <div class="col-5" v-if="item.day.nameS != null"><a class="s_link" href="classroom-timetable">{{item.day.groupS}}</a></div>
                        </div>
                        <div class="row">
                            <div class="col-12" v-if="item.day.name != null"> 
                                <span class="lesson_name">{{item.day.name}}</span>
                                <span class="square square-0" data-tooltip="Еженедельно"></span>
                                <p class="teacher"><a class="s_link" href="teacher-timetable">{{item.day.teacher}}</a></p>
                            </div>
        ...
        <div class="container d-none d-sm-none d-md-none d-lg-block d-xl-block">
            <h3 style="text-align: center;">Расписание аудитории {{classroom}}</h3>
            <div v-for="index in number" :key="index">
                <div class="card day">
                    <div class="card-header name-day">
                        {{days[index]}}
                    ...
                    <div class="card-body" v-for="(item, index2) in timetable[index]" :key="item.day.value">
                        <div class="row lesson" v-if="item.day.nameF != null && item.day.nameS != null">
                            ...
                            <div class="col-3 col-md-2"> 
                                <a class="s_link" href="classroom-timetable">{{item.day.groupF}}</a><br> 
                                <a class="s_link" href="classroom-timetable">{{item.day.groupS}}</a>
                            </div>
                        </div>
                        <div class="row  lesson" v-else>
                            ...
                            <div class="col-2" v-if="item.day.name != null"> <router-link class="s_link" :to="'/groups-timetable/' + item.day.group">{{item.day.group}}</router-link> </div>
                            <div class="col-2" v-if="item.day.nameF != null"> <router-link class="s_link" :to="'/groups-timetable/' + item.day.groupF">{{item.day.groupF}}</router-link> </div>
                            <div class="col-2" v-if="item.day.nameS != null"> <router-link class="s_link" :to="'/groups-timetable/' + item.day.groupS">{{item.day.groupS}}</router-link> </div>
                        </div>
                    </div>
                </div>
            </div>
