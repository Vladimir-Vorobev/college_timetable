<template>
	<div class="main container">
		<select
			class="custom-select custom-select-sm mb-3 events"
		...
		<div class="d-block d-sm-block d-md-block d-lg-none d-xl-none list">
			<div class="grade row">
				...
				<router-link
					style="width: 100%;"
					class="group_link"
					:to="'/groups-timetable/' + item.group.replace(/([/]+)/g, '*')"
					v-for="item in groups1"
					:key="item.group"
				>
